              ...
              <div className="card mt-3">
                <ul className="list-group list-group-flush">
                  <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <input className="col-sm-6 text-secondary"/>
                  </li>
                  <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
              ...
              <div className="card mb-3">
                <div className="card-body">
                  ...
                  <div className="row">
                    ...
                    <input type="date" className="col-sm-6 text-secondary"/>
                  ...
                  <div className='mx-3 w-100 d-flex justify-content-between'>
                  <div>
                  <button className="btn btn-dark">Go back</button>
                  </div>
                  <div>
                  <button className="btn btn-dark">Change image</button>
                  </div>
                  <div>
